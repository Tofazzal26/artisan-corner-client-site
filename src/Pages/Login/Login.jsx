  ...
  return (
    <div className="px-2 lg:px-0">
      <div className="bg-[#ffffff] mt-14 shadow-loginSd lg:w-1/2 md:w-2/3 mx-auto">
        <div className="md:w-2/3 lg:w-2/3 mx-auto border-2 rounded-md p-4 lg:p-14">
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="relative">
              ...
              />
              {errors.password && (
                <p className="text-red-600">This Password field is required</p>
              )}
            ...
            <p className="font-semibold text-[#706f6f] text-sm lg:text-lg text-center">
              ...
              <Link to="/register" className="text-[#eea12c]">
                Register
              </Link>
            </p>
          </form>
